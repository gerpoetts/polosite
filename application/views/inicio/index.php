			...
			<div class="row">
				<div class="col-md-6">
					<div class="panel panel-default">
					  <div class="panel-heading">¿Que es iPoloManager?</div>
					  <div class="panel-body">
					  	<p>Webapp creada en el 2016 por el departamento de TI de Poloplast Componentes cubriendo las demandas de los departamentos de <b>Ventas y Almacén</b> de manera rápida y sencilla que con el paso del tiempo será vital para la toma <b>de desiciones</b> para el futuro de la empresa gracias a los <b>Reportes</b> que este incorpora.</p>
					  </div>
					</div>
					<div class="panel panel-default">
					  <div class="panel-heading">Información de Contacto</div>
					  <ul class="list-group">
						<li class="list-group-item">- <a href="http://192.168.1.100/TI" target="blank">Departamento de TI</a></li>
						<li class="list-group-item">- <a href="mailto:german.galvan@poloplast.mx">Germán Galván</a></li>
				      </ul>
					</div>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-12">
					<iframe width="100%" height="600" src="https://www.youtube.com/embed/eX_iASz1Si8" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
		</div>
		<div class="well">
