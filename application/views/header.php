...
<html lang="en">
  <head>
    ...
    <meta name="author" content="German Galvan Moreno">
    ...
    <div class="container">
		...
		<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		  ...
		  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		    <ul class="nav navbar-nav">
		      ...
		      <?php endforeach; ?>
		      <li>
		      	<a href="http://192.168.1.100/doc" target="_blank">
		      		<i class="glyphicon glyphicon-question-sign"></i> Manual del Usuario
		      	</a>
		      </li>
		    </ul>
		    <ul class="nav navbar-nav navbar-right">
		      <li><a>Bienvenido <b title="<?php echo $this->user->Nombre; ?>"><?php echo $this->user->Nombre; ?></b></a></li>
        ...
        <div class="row">
            <div class="col-md-12" style="margin-top:40px;">
                ...
                <?php if(IS_DEMO == 1): ?>
                    <div class="alert alert-info text-center">
                        <blink>Esta es la <u>versión de prueba</u> para que puedas conocer que es lo que trae <b>IpOLO</b>.</blink>
                    </div>
                    <a target="_blank" href="http://192.168.1.100" class="btn btn-block btn-primary btn-lg">
                       iPOLOAPP
                    </a>
                <?php endif; ?>
            </div>
