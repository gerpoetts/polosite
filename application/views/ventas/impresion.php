...
<html>
	...
	<body>
		...
		<div id="container">
			...
			<div title="<?php echo $comprobante->ComprobanteTipo_id == 3 ? 'RFC' : 'DNI' ?> del Cliente" class="absolute" id="rfc" class="text-right"  style="left:420px;top:127px;"><?php echo $comprobante->ClienteIdentidad; ?></div>
