				...
				<div class="row">
					...
					<div class="col-md-4">
					  <div class="form-group">
						...
						<div class="col-md-2">
						  <div class="form-group">
						    <label><span id="spIdentidad">RFC</span> <span id="spRfcRequerido">(*)</span></label>
						    <input id="txtRfc" readonly="readonly" id="txtRfc" autocomplete="off" name="ClienteIdentidad" type="text" class="form-control required" placeholder="RFC" value="<?php echo $comprobante != null ? $comprobante->ClienteIdentidad : null; ?>" maxlenght="11" />
					  </div>
					</div>
					<div class="col-md-2">
					  <div class="form-group">
