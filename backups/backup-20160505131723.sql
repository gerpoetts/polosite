...
INSERT INTO comprobante (`id`, `Empresa_id`, `Serie`, `Correlativo`, `Cliente_id`, `ClienteIdentidad`, `ClienteNombre`, `ClienteDireccion`, `ComprobanteTipo_id`, `Estado`, `FechaRegistro`, `FechaEmitido`, `Iva`, `IvaTotal`, `SubTotal`, `Total`, `TotalCompra`, `Ganancia`, `Usuario_id`, `Glosa`, `Impresion`, `UsuarioImprimiendo_id`, `Devolucion`) VALUES (5, 4, NULL, NULL, '2', 'SISPOL2834252', 'SISTEMAS DE POLETA', 'IsajdfsaSadfasfAsdf', 3, 2, '2016/05/05', '2016/05/05', '16.00', '37655.17', '235344.83', '273000.00', '179400.00', '93600.00', 6, '', 0, NULL, 0);
...
CREATE TABLE `producto` (
  ...
  `Empresa_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf16 COLLATE=utf16_spanish_ci CHECKSUM=1;

INSERT INTO producto (`id`, `Nombre`, `UnidadMedida_id`, `PrecioCompra`, `Precio`, `Stock`, `StockMinimo`, `Marca`, `Empresa_id`) VALUES (1, 'PERSIANA SISTEMA', 'Kg', '126.00', '290.00', '8041.00', '0.00', 'CODEN', 4);
